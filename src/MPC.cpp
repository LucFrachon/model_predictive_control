 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    for (size_t t = 1; t < N; ++t) {
      ...
      //  we set fg[1 + x_start + t] = x(t+1) - x(t) - v(t) * cos(psi(t)) * dt, 
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  MPC::vectorXd transformCoord_MapToVehicle(Eigen::VectorXd state_m)
  {
  ...
  MPC::vectorXd transformCoord_VehicleToMap(Eigen::VectorXd stateMap)
  {}
